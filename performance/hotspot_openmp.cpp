...
//	system("/homes/h1tseng/Gordon/PMCS/tools/powermeter/powermeter_client 0.0.0.0 \"b\" 27072");
	...
	read_input(power, grid_rows, grid_cols, pfile);
    	...
    	perfstats_print();
    	perfstats_deinit();
	printf("Reading Input from file %ld seconds\n",((time_end.tv_sec * 1000000 + time_end.tv_usec) - (time_start.tv_sec * 1000000 + time_start.tv_usec))/1000000);
//	system("/homes/h1tseng/Gordon/PMCS/tools/powermeter/powermeter_client 0.0.0.0 \"e\" 27072");
	...
	free(power);
    	gettimeofday(&time_end, NULL);
	printf("HGProfile: Total %ld seconds\n",((time_end.tv_sec * 1000000 + time_end.tv_usec) - (total_start.tv_sec * 1000000 + total_start.tv_usec))/1000000);
